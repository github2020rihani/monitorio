 ...
 */
class getMesuringgunitRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\MesuringgunitRepository' shared autowired service.
     *
     * @return \App\Repository\MesuringgunitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MesuringgunitRepository.php';

        return $container->privates['App\\Repository\\MesuringgunitRepository'] = new \App\Repository\MesuringgunitRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
