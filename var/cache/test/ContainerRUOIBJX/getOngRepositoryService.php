 ...
 */
class getOngRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\OngRepository' shared autowired service.
     *
     * @return \App\Repository\OngRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OngRepository.php';

        return $container->privates['App\\Repository\\OngRepository'] = new \App\Repository\OngRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
