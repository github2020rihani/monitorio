 ...
 */
class getProjethistRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjethistRepository' shared autowired service.
     *
     * @return \App\Repository\ProjethistRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjethistRepository.php';

        return $container->privates['App\\Repository\\ProjethistRepository'] = new \App\Repository\ProjethistRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
