 ...
 */
class getContributeurRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContributeurRepository' shared autowired service.
     *
     * @return \App\Repository\ContributeurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContributeurRepository.php';

        return $container->privates['App\\Repository\\ContributeurRepository'] = new \App\Repository\ContributeurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
