 ...
 */
class getIndicaorhistRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\IndicaorhistRepository' shared autowired service.
     *
     * @return \App\Repository\IndicaorhistRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IndicaorhistRepository.php';

        return $container->privates['App\\Repository\\IndicaorhistRepository'] = new \App\Repository\IndicaorhistRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
