 ...
 */
class getIndicatorHistRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\IndicatorHistRepository' shared autowired service.
     *
     * @return \App\Repository\IndicatorHistRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IndicatorHistRepository.php';

        return $container->privates['App\\Repository\\IndicatorHistRepository'] = new \App\Repository\IndicatorHistRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
