 ...
 */
class getProjetPartRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjetPartRepository' shared autowired service.
     *
     * @return \App\Repository\ProjetPartRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjetPartRepository.php';

        return $container->privates['App\\Repository\\ProjetPartRepository'] = new \App\Repository\ProjetPartRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
