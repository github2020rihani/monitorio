 ...
 */
class getCartoOngRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\CartoOngRepository' shared autowired service.
     *
     * @return \App\Repository\CartoOngRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CartoOngRepository.php';

        return $container->privates['App\\Repository\\CartoOngRepository'] = new \App\Repository\CartoOngRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
