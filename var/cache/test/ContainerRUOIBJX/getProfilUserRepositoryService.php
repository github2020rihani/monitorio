 ...
 */
class getProfilUserRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilUserRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilUserRepository.php';

        return $container->privates['App\\Repository\\ProfilUserRepository'] = new \App\Repository\ProfilUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
