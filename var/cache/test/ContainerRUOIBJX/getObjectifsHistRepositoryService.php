 ...
 */
class getObjectifsHistRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObjectifsHistRepository' shared autowired service.
     *
     * @return \App\Repository\ObjectifsHistRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObjectifsHistRepository.php';

        return $container->privates['App\\Repository\\ObjectifsHistRepository'] = new \App\Repository\ObjectifsHistRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
