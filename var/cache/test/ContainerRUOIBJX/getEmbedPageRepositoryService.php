 ...
 */
class getEmbedPageRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmbedPageRepository' shared autowired service.
     *
     * @return \App\Repository\EmbedPageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmbedPageRepository.php';

        return $container->privates['App\\Repository\\EmbedPageRepository'] = new \App\Repository\EmbedPageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
