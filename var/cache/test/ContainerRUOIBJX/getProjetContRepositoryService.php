 ...
 */
class getProjetContRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjetContRepository' shared autowired service.
     *
     * @return \App\Repository\ProjetContRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjetContRepository.php';

        return $container->privates['App\\Repository\\ProjetContRepository'] = new \App\Repository\ProjetContRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
