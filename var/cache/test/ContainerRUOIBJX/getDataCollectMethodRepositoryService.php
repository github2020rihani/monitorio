 ...
 */
class getDataCollectMethodRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\DataCollectMethodRepository' shared autowired service.
     *
     * @return \App\Repository\DataCollectMethodRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DataCollectMethodRepository.php';

        return $container->privates['App\\Repository\\DataCollectMethodRepository'] = new \App\Repository\DataCollectMethodRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
