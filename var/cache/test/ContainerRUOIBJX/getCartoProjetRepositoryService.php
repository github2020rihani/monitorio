 ...
 */
class getCartoProjetRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\CartoProjetRepository' shared autowired service.
     *
     * @return \App\Repository\CartoProjetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CartoProjetRepository.php';

        return $container->privates['App\\Repository\\CartoProjetRepository'] = new \App\Repository\CartoProjetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
