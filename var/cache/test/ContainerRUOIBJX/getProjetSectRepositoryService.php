 ...
 */
class getProjetSectRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjetSectRepository' shared autowired service.
     *
     * @return \App\Repository\ProjetSectRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjetSectRepository.php';

        return $container->privates['App\\Repository\\ProjetSectRepository'] = new \App\Repository\ProjetSectRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
