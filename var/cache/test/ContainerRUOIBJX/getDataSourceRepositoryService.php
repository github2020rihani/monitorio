 ...
 */
class getDataSourceRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\DataSourceRepository' shared autowired service.
     *
     * @return \App\Repository\DataSourceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DataSourceRepository.php';

        return $container->privates['App\\Repository\\DataSourceRepository'] = new \App\Repository\DataSourceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
