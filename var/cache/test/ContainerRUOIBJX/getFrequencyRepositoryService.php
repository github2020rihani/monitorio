 ...
 */
class getFrequencyRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\FrequencyRepository' shared autowired service.
     *
     * @return \App\Repository\FrequencyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FrequencyRepository.php';

        return $container->privates['App\\Repository\\FrequencyRepository'] = new \App\Repository\FrequencyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
