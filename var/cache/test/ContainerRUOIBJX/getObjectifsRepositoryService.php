 ...
 */
class getObjectifsRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObjectifsRepository' shared autowired service.
     *
     * @return \App\Repository\ObjectifsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObjectifsRepository.php';

        return $container->privates['App\\Repository\\ObjectifsRepository'] = new \App\Repository\ObjectifsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
