...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\PaysFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProjetFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['App\\Repository\\ProfilRepository'] ?? $container->load('getProfilRepositoryService'))), 'groups' => []]]);
