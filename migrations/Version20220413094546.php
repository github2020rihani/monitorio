 ...
 */
final class Version20220413094546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carto_ong (id INT AUTO_INCREMENT NOT NULL, type_carto VARCHAR(255) NOT NULL, date_creat DATETIME NOT NULL, user_creat VARCHAR(255) NOT NULL, date_modif DATETIME NOT NULL, user_motif VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE carto_projet (id INT AUTO_INCREMENT NOT NULL, projet_id INT DEFAULT NULL, type_catro VARCHAR(1) DEFAULT NULL, date_creat DATETIME NOT NULL, user_creat VARCHAR(255) NOT NULL, date_modif DATETIME NOT NULL, user_motif VARCHAR(255) NOT NULL, INDEX IDX_D731E050C18272 (projet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, code_projet VARCHAR(5) DEFAULT NULL, titre_projet VARCHAR(51) DEFAULT NULL, desc_projet VARCHAR(27) DEFAULT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, etat_proj VARCHAR(1) DEFAULT NULL, div_org_unit VARCHAR(255) DEFAULT NULL, is_program TINYINT(1) DEFAULT NULL, prog_id INT NOT NULL, login_admin VARCHAR(12) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, coord_lat VARCHAR(255) DEFAULT NULL, coord_long VARCHAR(255) DEFAULT NULL, budget DOUBLE PRECISION DEFAULT NULL, main_contact VARCHAR(17) DEFAULT NULL, date_creat DATETIME NOT NULL, user_creat VARCHAR(255) NOT NULL, date_modif DATETIME NOT NULL, user_motif VARCHAR(255) NOT NULL, INDEX IDX_50159CA964D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
